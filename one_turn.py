...
from Chatbot import generate_response, prepare_chatbot, get_score
...
def main():
    ...
    parser.add_argument(
        "--model_checkpoint", type=str, default="model/gpt2_model/"
    )
    ...
    parser.add_argument(
        "--model_name", type=str, default="one_try"
    ...
    optimizer = AdamW(model.parameters(), lr=1e-5, eps=1e-5)
