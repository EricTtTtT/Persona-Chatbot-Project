...
def eval(chatbot, interlocutor, tokenizer, train_loader, args, args_bot):
    ...
    print(record.keys())
    exit(0)
    dict_keys(['hello what are doing today?', 'i just got done watching a horror movie', 'wow! i do love a good horror movie. loving this cooler weather', 'yes! my son is in junior high and i just started letting him watch them too', 'neat!! i used to work in the human services field', 'yes i bet you can get hurt. my wife works and i stay at home', 'hi! how are you doing tonight?', 'great. in my spare time i do volunteer work.', 'i work in a homeless shelter in my town.', 'cool. not really into cars. my day job is wrestling.', 'yes, i love the crowds, getting to know people.', 'hello, how are you doing?', "that is great, me too! i'm married and my husband and i've 2 children.", 'no, we recently purchased a new house, so we cannot afford it. have you?', 'i enjoy going to concerts, i see the rolling stones every year.', 'maybe you should consider going back to school. i did. i major in economics.', 'hi how are you doing? i am okay how about you?', 'i used to do home health aide but now i am disabled.', "i graduated and got my license worked a while and became i'll.", 'i have dogs and i walk them. and a cat.', 'i enjoy reading read about michael jackson and psychology today.', 'hi i dye my hair 4 times a year', "no i do not, i've a dream, it is to work from home", 'that is really cool that you can do that', "no i don't, i faint when i see blood", "i went to school to be a vet, but i didn't like it", 'hi! do you like turtles?', 'i have a turtle his name is speedy. kitties are nice too, tho!', 'what are your kitties names?', 'i like that! i go to preschool.', 'how old are you? i turned four on my birthday!', 'hello, how are you tonight? do you have pink and blue hair?', 'what do you like to do in your spare time? i bird watch.', "those are fun. i've a cat, do you?"])
    # optimizer.zero_grad()
    record = {}
    data = ['hello what are doing today?', 'i just got done watching a horror movie', 'wow! i do love a good horror movie. loving this cooler weather', 'yes! my son is in junior high and i just started letting him watch them too', 'neat!! i used to work in the human services field', 'yes i bet you can get hurt. my wife works and i stay at home', 'hi! how are you doing tonight?', 'great. in my spare time i do volunteer work.', 'i work in a homeless shelter in my town.', 'cool. not really into cars. my day job is wrestling.', 'yes, i love the crowds, getting to know people.', 'hello, how are you doing?', "that is great, me too! i'm married and my husband and i've 2 children.", 'no, we recently purchased a new house, so we cannot afford it. have you?', 'i enjoy going to concerts, i see the rolling stones every year.', 'maybe you should consider going back to school. i did. i major in economics.', 'hi how are you doing? i am okay how about you?', 'i used to do home health aide but now i am disabled.', "i graduated and got my license worked a while and became i'll.", 'i have dogs and i walk them. and a cat.', 'i enjoy reading read about michael jackson and psychology today.', 'hi i dye my hair 4 times a year', "no i do not, i've a dream, it is to work from home", 'that is really cool that you can do that', "no i don't, i faint when i see blood", "i went to school to be a vet, but i didn't like it", 'hi! do you like turtles?', 'i have a turtle his name is speedy. kitties are nice too, tho!', 'what are your kitties names?', 'i like that! i go to preschool.', 'how old are you? i turned four on my birthday!', 'hello, how are you tonight? do you have pink and blue hair?', 'what do you like to do in your spare time? i bird watch.', "those are fun. i've a cat, do you?"]
